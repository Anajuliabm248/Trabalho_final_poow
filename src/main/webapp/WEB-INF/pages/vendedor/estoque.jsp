...
<main class="page-wrap py-4">
    ...
    <section class="surface panel">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-3">
            ...
            <a href="${pageContext.request.contextPath}/livros/novo" class="btn btn-brand">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-2 flex-wrap">
                                <a href="${pageContext.request.contextPath}/livros/${livro.id}/editar" class="btn btn-soft-outline btn-sm">Editar</a>
                                <form method="post" action="${pageContext.request.contextPath}/livros/${livro.id}/excluir"
                                      onsubmit="return confirm('Excluir este livro?')" style="display:inline">
